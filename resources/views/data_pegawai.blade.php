                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" placeholder="name@example.com"
                                                            class="form-control form-control" id="emailPegawai"
                                                            placeholder="" />
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <label for="nohpPegawai">No hp Pegawai</label>
                                                        <input type="text" class="form-control form-control"
                                                            id="nohpPegawai" placeholder="" />
                                                    </div>
                                                </div>
