    ...
    <div class="page-inner">
        <div class="page-header">
            ...
            <ul class="breadcrumbs mb-3">
                ...
                <li class="separator"><i class="icon-arrow-right"></i></li>
                <li class="nav-item"><a href="#">Laporan Barang Keluar</a></li>
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <!-- Tabel Laporan -->
                    <div class="card-body">
                        @if ($laporanKeluar->isEmpty())
                            <div class="alert alert-warning text-center" role="alert">
                                Tidak ada Data Laporan Keluar.
                            </div>
                        @else
...
<script>
    $(document).ready(function() {
        ...
        $('#filterForm').on('submit', function(event) {
            ...
            $.ajax({
                url: "{{ route('laporanKeluar.filter') }}",
                method: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
...
<script>
    $(document).ready(function() {
        ...
        $('#printLaporan').on('click', function() {
            ...
            let url = `{{ route('laporanKeluar.print') }}?start_date=${startDate}&end_date=${endDate}`;
